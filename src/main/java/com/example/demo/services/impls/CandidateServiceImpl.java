...
public class CandidateServiceImpl implements CandidateService {
  ...
  public CandidateDashboardDTO getDashboard() {
    Integer totalCandidate = candidateRepository.countAll();
    Integer candidatePassCV = candidateRepository.countAllByStatusDG(StatusEnum.DANH_GIA);
    Integer candidateFailedCV = candidateRepository.countAllByStatusDG(StatusEnum.TU_CHOI);
    Integer candidateAdmitted = candidateRepository.countAllByStatusPV(StatusEnum.KET_LUAN_DONG_Y);
    Integer candidateFailed = candidateRepository.countAllByStatusPV(StatusEnum.KET_LUAN_TU_CHOI);
